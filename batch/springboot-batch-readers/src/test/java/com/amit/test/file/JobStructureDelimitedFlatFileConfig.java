...
public class JobStructureDelimitedFlatFileConfig extends AbstractBatchConfiguration {
	...
	public ItemReader<Product> productItemReader() {
		...
		reader.setResource(new ClassPathResource("/test/input/products-delimited.txt"));
