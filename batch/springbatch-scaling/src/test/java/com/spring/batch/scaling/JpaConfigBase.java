...
public abstract class JpaConfigBase {
	static Logger log = LoggerFactory.getLogger(JpaConfigBase.class);
	...
	public DataSource dataSource() {
		return getTomcatDataSource("org.h2.Driver",
		                           "jdbc:h2:mem:" + getDatabaseName() + ";DB_CLOSE_ON_EXIT=FALSE",
		                           "sa",
		                           "");
	}
	 ...
	 * @return the tomcat com.hconnect.data source
	 */
