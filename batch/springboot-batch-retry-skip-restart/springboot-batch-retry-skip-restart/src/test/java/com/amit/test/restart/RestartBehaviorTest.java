...
public class RestartBehaviorTest {
    ...
    public void notRestartable() throws Exception {
        ...
        Assertions.assertThat(exec.getStatus()).isEqualTo(BatchStatus.FAILED);
        try {
    ...
    public void allowStartIfCompleteTest() throws Exception {
        ...
        Assertions.assertThat(firstStepExec.getExitStatus().getExitCode()).isEqualTo(ExitStatus.COMPLETED.getExitCode());
        Assertions.assertThat(secondStepExec.getExitStatus().getExitCode()).isEqualTo(ExitStatus.FAILED.getExitCode());
    ...
    public void startLimit() throws Exception {
        ...
        Assertions.assertThat(exec.getStatus()).isEqualTo(BatchStatus.FAILED);
        Assertions.assertThat(exec.getStepExecutions().size()).isEqualTo(1);
        ...
        exec = jobLauncher.run(importProductsLimitJob, jobParameters);
        Assertions.assertThat(exec.getStepExecutions().size()).isEqualTo(0);
