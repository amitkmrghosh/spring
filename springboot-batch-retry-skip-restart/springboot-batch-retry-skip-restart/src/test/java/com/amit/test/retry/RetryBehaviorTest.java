...
import com.amit.test.AbstractRobustnessBatchTest;
...
public class RetryBehaviorTest extends AbstractRobustnessBatchTest {
	...
	public void exceptionReading() throws Exception {
		...
		Assertions.assertThat(exec.getExitStatus().getExitCode()).isEqualToIgnoringCase(ExitStatus.FAILED.getExitCode());
	...
	public void exceptionInWritingSkippable() throws Exception {
		...
		Assertions.assertThat(exec.getExitStatus().getExitCode()).isEqualToIgnoringCase(ExitStatus.COMPLETED.getExitCode());
