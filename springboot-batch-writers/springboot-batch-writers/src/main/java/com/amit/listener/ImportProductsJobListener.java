...
/**
 * kr.spring.batch.chapter03.listener.ImportProductsJobListener
 *
...
public class ImportProductsJobListener implements JobExecutionListener {
	...
	Logger log = LoggerFactory.getLogger(ImportProductsJobListener.class);
